...
import { Alert, Block, Checkbox, Empty, Flexbox, Segmented, Tag, Text, Tooltip, toast } from '@lobehub/ui'
            ...
            {visibleDevices.map((device) => {
              ...
              return (
                <Block
                  ...
                  variant="outlined"
                >
                  <Button className="preview-select" type="text" onClick={() => selectDevice(device)}>
                    <DevicePreview
