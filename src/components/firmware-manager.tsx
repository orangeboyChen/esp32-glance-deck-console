...
export function FirmwareManager() {
  ...
  return <main className="sources-shell">
    <ConsolePageHeader back_label={translate('back')} eyebrow={translate('eyebrow')} icon={Cpu} language_label={translate('language')} subtitle={translate('subtitle')} title={translate('title')} />
